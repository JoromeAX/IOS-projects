...
//  WorkoutUIKit
//
//  Created by Roman Khancha on 03.07.2023.
//
...
final class TimerView: WABaseInfoView {
    private let elapsedTimeLabel: UILabel = {
        let label = UILabel()
        label.text = R.Title.Session.elapsedTime
    ...
    private let remainingTimeLabel: UILabel = {
        let label = UILabel()
        label.text = R.Title.Session.remainingTime
    ...
    func configure(with duration: Double, progress: Double) {
        ...
        completedPercentView.configure(with: R.Title.Session.completedPercent, andValue: roundedPercent)
        remainingPercentView.configure(with: R.Title.Session.remainingPercent, andValue: 100 - roundedPercent)
